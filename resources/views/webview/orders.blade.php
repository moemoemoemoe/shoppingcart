...
$.ajax({
            ...
            success: function(data){
                ...
                if(data.status == 1){
                   ...
                   $('#eye_'+id).html('<a href="{!! route('view_order_by_driver', ['inv'=><?php echo $order->inv_id ?>]) !!}" type="button" class="btn-floating btn-small btn-primary" style="background-color: green"><i class="fa fa-eye"></i></a>');
