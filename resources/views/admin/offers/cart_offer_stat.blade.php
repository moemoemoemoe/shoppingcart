...
<div class='input-group date' id='datetimepicker1'>
              ...
              <p>
                <div class="panel-heading text-center" style="font-weight: 900">{{count($carts_notassigned)}} Invoice no set</div>
                <div class="panel-heading text-center" style="font-weight: 900">{{count($carts_assigned)}} Invoice set</div>
                <div class="panel-heading text-center" style="font-weight: 900">{{count($carts_assigned_verified)}} Invoice verified</div>
                <div class="panel-heading text-center" style="font-weight: 900">{{count($carts_finish_shop)}} Invoice finish shop no deliverd</div>
                <div class="panel-heading text-center" style="font-weight: 900">{{count($carts_delivered)}} Invoice Deliverd</div>
              </p>
