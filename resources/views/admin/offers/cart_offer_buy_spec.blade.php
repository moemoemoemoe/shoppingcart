...
$.ajax({
 ...
 setTimeout(function(){
                ...
                window.location.replace('http://test.arcazur.com/admin/view_cart_offer_spec/'+invoice);
            }, 1000);
 ...
 setTimeout(function(){
                ...
                window.location.replace('http://test.arcazur.com/admin/view_cart_offer_spec/'+original_invoice);
            }, 1000);
                ...
                {
 window.alert(data.message)
window.location.replace('http://test.arcazur.com/admin/view_cart_offer');
                }
